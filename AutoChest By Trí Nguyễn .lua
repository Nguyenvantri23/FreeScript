...
for _, msg in pairs({
    "<Color=Red>Welcome to TriDepZai Hub AutoChest 🔥<Color=/>",
    "<Color=Green>TikTok: Vantridz1509<Color=/>",
    "<Color=Yellow>Auto Chest by Trí Nguyễn 🤓<Color=/>",
    "<Color=Blue>Hết Rồi Thằng Lồn Nhìn Con Cặc 💀<Color=/>",
}) do
    require(Notifications).new(msg):Display()
end
 
 local Hub = Material.Load({
	Title = "TriDepZai Hub[AutoChest] ",
	Style = 3,
	SizeX = 300,
	SizeY = 300,
	Theme = "Red",
